...
class CryoChamberTab(Tab):
    ...
    def _load_project_data(self, evt: wx.Event) -> bool:
        ...
        # NOTE: this must be called with @call_in_wx_main to force the call to happen after existing stream addition events
        localization_tab._start_streams_subscriber()
